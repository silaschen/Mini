...
<!--         <div class="col-xs-4 col-md-2">
        ...
        <div class="col-xs-8 col-md-6">
          <div class="input-group">
            ...
            <?php if($_GET['type'] > '0' OR $_GET['word'] != ''): ?><a title='清除条件' class="input-group-addon" href="<?php echo U('User/userlist');?>"><i class="fa fa-remove"></i></a><?php endif; ?>
          </div>
        </div>
      </div>
      </form>
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td><?php if($vo["type"] == 1): ?>普通会员<?php elseif($vo["type"] == 2): ?>推荐人<?php elseif($vo["type"] == 3): ?><span style="color: red
          ">管理员</span><?php endif; ?></td>
