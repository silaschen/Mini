...
if(!isNaN('<?php echo ($eq); ?>')){
  ...
  <div class="box box-danger">
    ...
    <div class="box-body">
      <form role="form" id='form' action="<?php echo U('Sys/site');?>" method="POST">
         <div class="form-group">
          <label>站点名称</label>
          <input type="text" name='SITE_NAME' class="form-control" placeholder="" value="<?php echo C('SITE_NAME');?>">
        </div>
        <div class="form-group">
          ...
          <button style="margin-bottom:8px;" type='button' class='btn btn-default fileinput-button'><i class="glyphicon glyphicon-picture"></i> <small>点击上传</small><input data-id="logopic" class="upload" type="file" name="files" accept="image/*" ></button>
            ...
            <input class='hide' name="SITE_LOGO" id='logopic' value="<?php echo C('SITE_LOGO');?>">
        </div>
        <div class="form-group">
          ...
          <button style="margin-bottom:8px;" type='button' class='btn btn-default fileinput-button'><i class="glyphicon glyphicon-picture"></i> <small>点击上传</small><input data-id='qrpic' class="upload" type="file" name="files" accept="image/*" ></button>
            ...
            <input class='hide' name="SITE_QRPIC" id='qrpic' value="<?php echo C('SITE_QRPIC');?>">
        </div>
        <div class="form-group">
          <label>客服电话</label>
          <input type="text" name='SITE_TEL' class="form-control" placeholder="" value="<?php echo C('SITE_TEL');?>">
        </div>
        <div class="form-group">
          <label>联系地址</label>
          <input type="address" name='SITE_ADR' class="form-control" placeholder="" value="<?php echo C('SITE_ADR');?>">
        </div>
        <div class="form-group">
          <label>管理员邮箱</label>
          <input type="email" name='SITE_EMAIL' class="form-control" placeholder="" value="<?php echo C('SITE_EMAIL');?>">
        </div>
