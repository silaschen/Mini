...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs pull-right">
      ...
      <li class='active'><a href="<?php echo U('Cmd/text');?>">文本规则</a></li>
    ...
    <div class="tab-content">
		<div class="tab-pane active">
			 <table class="table table-bordered">
					<thead><th>发送</th><th>回复内容</th><th>预览/追加</th><th>状态</th><th>管理</th></thead>
					<tbody>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><?php echo ($vo["keyword"]); ?></td><td><?php echo ($vo["type"]); ?></td><td>
						  	...
						  	<td>
						  	<a class="label label-danger" href="javascript:delforcmd(<?php echo ($vo["id"]); ?>,1);">删除</a>
						  	<?php if($vo["status"] == '1'): ?><a class="label label-warning" href="javascript:cmdstatus(<?php echo ($vo["id"]); ?>,1,0);">禁用</a>
						  	<?php else: ?>
						  	<a class="label label-success" href="javascript:cmdstatus(<?php echo ($vo["id"]); ?>,1,1);">启用</a><?php endif; ?>
						  	<a class="label label-info" href="javascript:textmodify(<?php echo ($vo["id"]); ?>);">修改</a>
