...
$api_key = 'sk_test_SyTGm90e1q18vPu9GSqrbDuH';
$app_id = 'app_jnHO0Sarrj9KPKeT';
...
//     exit();
// }
$input_data['channel'] = $_GET['channel'];
$input_data['amount'] = $_GET['amount'];
...
switch ($channel) {
    ...
    case 'wx_pub':
        $extra = array(
            'open_id' => 'oYYe7wS-If6hvmXjxkpYL_8-jvg4'
        );
        break;
    case 'wx_pub_qr':
        $extra = array(
