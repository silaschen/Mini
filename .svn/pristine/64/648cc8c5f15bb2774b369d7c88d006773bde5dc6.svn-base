...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
		<div class="tab-pane active">
			<div class='view well'><?php echo ($info["v"]); ?></div>
	        <div class="btn-group">
	        ...
	        <textarea class="form-control" rows="3" name='textbox' id='textbox'><?php echo ($info["o"]); ?></textarea>

		</div><!-- /.tab-pane -->
		<div class="clearfix"><br>
			<a href="javascript:history.go(-1);" class='btn btn-default pull-left'>返回</a>
			<button type="button" class="btn btn-success pull-right" onclick='savetext(<?php echo ($info["id"]); ?>);'>确定</button>
		</div>
    </div><!-- /.tab-content -->
</div>
